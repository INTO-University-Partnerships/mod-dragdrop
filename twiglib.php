...
// wrapper around outputting a pix icon
$app['twig']->addFunction(new Twig_SimpleFunction('pix_icon', function ($pix, $alt = '', $component = 'moodle', array $attributes = null) {
    /** @var core_renderer */
    global $OUTPUT;
    return $OUTPUT->pix_icon($pix, $alt, $component, $attributes);
}));
